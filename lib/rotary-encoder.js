...
RotaryEncoder.prototype = Object.create(EventEmitter.prototype);

RotaryEncoder.prototype.getDelta = function () {
  var aState = wpi.digitalRead(this.pinA),
      bState = wpi.digitalRead(this.pinB),
      seq    = (aState ^ bState) | bState << 1,
      delta;

  delta = (seq - this.previousSeq) % 4;
...
//     case 0: // no change
//             break;
//     case 1: // 1 step clockwise
//             this.emit('clockwise');
//             break;
//     case 2: // 2 steps clockwise or counter-clockwise
//             // (transition missed)
//             break;
//     case 3: // 1 step counter clockwise
//             this.emit('anticlockwise');
//             break;
//     default: // error?
//   }

//   timers.setTimeout(this.handleEvent.bind(this), this.pollIntervalMs);
// };
